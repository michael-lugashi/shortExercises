...
changeBackgroundColor('blue', 2000, notChanged,
    ...
    () => {changeBackgroundColor('red', 2000, notChanged, 
    () => {changeBackgroundColor('purpl', 2000, notChanged, 
    () => {changeBackgroundColor('yellow', 2000, notChanged,
    () => {changeBackgroundColor('brown', 2000, notChanged,
    ()=> {})})})})})})})
